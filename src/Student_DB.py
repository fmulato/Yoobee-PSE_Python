"""
This project was developed as part of the MSE800_Professional Software Engineering course
 taught by Professor Guan Wang.

Exercise - week3 class 2":
Python application to manage student information. This application should be able to perform the following functions:
...
treatments for connections and other

** Portions of the code were adapted from the course materials at Yoobee Colleges - week3.
"""
...
# information's file to connect to database
...
class Database: #**
    ...
    def query(self):
        try:
            cursor = self.creat_connection_parser()
            self.name = input("Type the name of the student (or part of it) : ").upper()
            value = (f"%{self.name}%",)
